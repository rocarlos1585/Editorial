  ...
  sendPedido=()=>{
            ...
            promise.then(
              function(offset){
                ...
                var referencia=ref.child('Editorial/Devoluciones'+'/'+anio+'/'+mes+'/'+dia);
                var referenciaPush = referencia.push();
                var query='Devolucion de '+userReplaced+' en '+anio+'/'+mes+'/'+dia;
                referenciaPush.set({
                  userReplaced,
                  status,
                  nombre:query,
                ...
                var referenciaLibros = ref.child('Editorial/Devoluciones'+'/'+anio+'/'+mes+'/'+dia+'/'+keyLibros)
    ...
    return(
      <div className ="Todo">
        ...
        <div className="botones">
          ...
          <RaisedButton label="Solicitar devolución" onClick={this.sendPedido} primary={true}/>
        </div>
